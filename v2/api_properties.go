...
@return ModelMap
*/
func (a *PropertiesApiService) GetCommitHostedPropertyValue(ctx context.Context, workspace string, repoSlug string, commit string, appKey string, propertyName string) (ModelMap, *http.Response, error) {
	var (
...
@return ModelMap
*/
func (a *PropertiesApiService) GetPullRequestHostedPropertyValue(ctx context.Context, workspace string, repoSlug string, pullrequestId string, appKey string, propertyName string) (ModelMap, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return ModelMap
*/
func (a *PropertiesApiService) GetRepositoryHostedPropertyValue(ctx context.Context, workspace string, repoSlug string, appKey string, propertyName string) (ModelMap, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return ModelMap
*/
func (a *PropertiesApiService) RetrieveUserHostedPropertyValue(ctx context.Context, selectedUser string, appKey string, propertyName string) (ModelMap, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
Update an [application property](/cloud/bitbucket/application-properties/) value stored against a commit.
  ...
  - @param propertyName The name of the property.
*/
func (a *PropertiesApiService) UpdateCommitHostedPropertyValue(ctx context.Context, body ModelMap, workspace string, repoSlug string, commit string, appKey string, propertyName string) (*http.Response, error) {
	var (
...
Update an [application property](/cloud/bitbucket/application-properties/) value stored against a pull request.
  ...
  - @param propertyName The name of the property.
*/
func (a *PropertiesApiService) UpdatePullRequestHostedPropertyValue(ctx context.Context, body ModelMap, workspace string, repoSlug string, pullrequestId string, appKey string, propertyName string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
Update an [application property](/cloud/bitbucket/application-properties/) value stored against a repository.
  ...
  - @param propertyName The name of the property.
*/
func (a *PropertiesApiService) UpdateRepositoryHostedPropertyValue(ctx context.Context, body ModelMap, workspace string, repoSlug string, appKey string, propertyName string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
Update an [application property](/cloud/bitbucket/application-properties/) value stored against a user.
  ...
  - @param propertyName The name of the property.
*/
func (a *PropertiesApiService) UpdateUserHostedPropertyValue(ctx context.Context, body ModelMap, selectedUser string, appKey string, propertyName string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
